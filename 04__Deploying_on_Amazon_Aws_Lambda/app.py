...
file_path = '02__supporting_csv_files/mean.csv'
mean      = np.loadtxt(file_path, delimiter=',')
print(mean)

# Loading standard deviations for each feature
file_path = '02__supporting_csv_files/standard_deviation.csv'
std       = np.loadtxt(file_path, delimiter=',')
print(std)

# Loading best weights from all models
file_path = '02__supporting_csv_files/best_weights.csv'
...
with open('01__models/gmm_model.pkl', 'rb') as file:
    gmm_model = pickle.load(file)

# Loading the saved NN model
NN_model = load_model('01__models/NN_model.keras')

# Loading the saved XGBoost model
with open('01__models/XGB_model.pkl', 'rb') as file:
    XGB_model = pickle.load(file)

# Loading the saved RF model from the file
with open('01__models/RF_model.pkl', 'rb') as file:
    RF_model = pickle.load(file)
